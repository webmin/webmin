...
Recommends: perl(DateTime) perl(DateTime::TimeZone) perl(DateTime::Locale) perl(Time::Piece) perl(Encode::Detect) lynx shared-mime-info perl-File-Basename perl-File-Path
AutoReq: 0
