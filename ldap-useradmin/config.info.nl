...
pass=Referenties voor bind namen boven,12
user_base=Basis voor gebruikers,3,Van NSS config file
group_base=Basis voor groepen,3,Van NSS config file
other_class=Andere object klassen om toe te voegen aan nieuwe gebruikers,0
...
group_mod_props=LDAP eigenschappen voor gemodificeerde groepen<br><i>veldnaam</i> <i>omschrijving</i> formaat),9,40,3,\t
...
person=Geef alle Unix gebruikers de <tt>persoon</tt> object klas?,1,1-Ja,0-Nee
user_filter=Extra LDAP filter voor gebruikers,3,Geen,,,,Attributen=waarde
group_filter=Extra LDAP filter voor groepen,3,Geen,,,,Attributen=waarde
...
default_expire=Standaard expiratie datum voor nieuwe gebruikers (dd/mm/jjjj),3,Van Gebruikers en Groepen module
...
samba_class=LDAP object klas voor Samba gebruikers,10,sambaAccount-sambaAccount (Samba 2),sambaSamAccount-sambaSamAccount (Samba),Anders
...
samba_gclass=LDAP object klas voor Samba groepen,10,-sambaGroep (Samba 2),sambaSamGroep-sambaSamGroep (Samba 3 oude schema),sambaGroepMapping-sambaGroepMapping (Samba 3 nieuw schema),Anders
...
imap_folders=Mappen om te maken voor nieuwe IMAP gebruikers,9,30,3,\t
imap_folderalt=Pad voor mappen,1,1-gebruiker.$gebruiker.$map,0-$map
imap_foldersep=Map afscheiding,1,.-.,/-/
...
quota_support=IMAP server ondersteund quota's?,1,1-Ja,0-Nee
...
line4=Vooraf en achteraf opdrachten,11
