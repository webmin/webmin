...
lease=Dozwolona liczba sekund ró¿nicy pomiêdzy czasem systemowym i&nbsp;sprzêtowym,0
timeserver=Domy¶lny serwer czasu,3,Brak
ntp_only=U¿yæ tylko NTP do synchronizacji czasu?,1,1-Tak,0-Nie
...
hwclock_flags=Flagi linii poleceñ dla hwclock,10,-Brak,sysconfig-Z /etc/sysconfig/clock
