...
return { 'af'             => 'Afrikaans',
         ...
         'az-Cyrl-AZ'     => 'азәрбајҹан (Азәрбајҹан Кирил)',
         'az-Latn'        => 'azərbaycan (latın)',
         'az-Latn-AZ'     => 'azərbaycan (Azərbaycan latın)',
         'bas'            => 'Ɓàsàa',
         ...
         'bs-Cyrl-BA'     => 'босански (Босна и Херцеговина ћирилица)',
         ...
         'ff'             => 'Pulaar',
         'ff-Adlm'        => '𞤆𞤵𞤤𞤢𞤪 (𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-BF'     => '𞤆𞤵𞤤𞤢𞤪 (𞤄𞤵𞤪𞤳𞤭𞤲𞤢 𞤊𞤢𞤧𞤮𞥅 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-CM'     => '𞤆𞤵𞤤𞤢𞤪 (𞤑𞤢𞤥𞤢𞤪𞤵𞥅𞤲 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-GH'     => '𞤆𞤵𞤤𞤢𞤪 (𞤘𞤢𞤲𞤢 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-GM'     => '𞤆𞤵𞤤𞤢𞤪 (𞤘𞤢𞤥𞤦𞤭𞤴𞤢 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-GN'     => '𞤆𞤵𞤤𞤢𞤪 (𞤘𞤭𞤲𞤫 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-GW'     => '𞤆𞤵𞤤𞤢𞤪 (𞤘𞤭𞤲𞤫-𞤄𞤭𞤧𞤢𞤱𞤮𞥅 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-LR'     => '𞤆𞤵𞤤𞤢𞤪 (𞤂𞤢𞤦𞤭𞤪𞤭𞤴𞤢𞥄 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-MR'     => '𞤆𞤵𞤤𞤢𞤪 (𞤃𞤮𞤪𞤼𞤢𞤲𞤭𞥅 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-NE'     => '𞤆𞤵𞤤𞤢𞤪 (𞤐𞤭𞥅𞤶𞤫𞤪 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-NG'     => '𞤆𞤵𞤤𞤢𞤪 (𞤐𞤢𞤶𞤫𞤪𞤭𞤴𞤢𞥄 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-SL'     => '𞤆𞤵𞤤𞤢𞤪 (𞤅𞤢𞤪𞤢𞤤𞤮𞤲 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Adlm-SN'     => '𞤆𞤵𞤤𞤢𞤪 (𞤅𞤫𞤲𞤫𞤺𞤢𞥄𞤤 𞤀𞤁𞤂𞤢𞤃)',
         'ff-Latn'        => 'Pulaar (Latn)',
         'ff-Latn-BF'     => 'Pulaar (Burkibaa Faaso Latn)',
         'ff-Latn-CM'     => 'Pulaar (Kameruun Latn)',
         'ff-Latn-GH'     => 'Pulaar (Ganaa Latn)',
         'ff-Latn-GM'     => 'Pulaar (Gammbi Latn)',
         'ff-Latn-GN'     => 'Pulaar (Gine Latn)',
         'ff-Latn-GW'     => 'Pulaar (Gine-Bisaawo Latn)',
         'ff-Latn-LR'     => 'Pulaar (Liberiyaa Latn)',
         'ff-Latn-MR'     => 'Pulaar (Muritani Latn)',
         'ff-Latn-NE'     => 'Pulaar (Nijeer Latn)',
         'ff-Latn-NG'     => 'Pulaar (Nijeriyaa Latn)',
         'ff-Latn-SL'     => 'Pulaar (Seraa liyon Latn)',
         'ff-Latn-SN'     => 'Pulaar (Senegaal Latn)',
         'fi'             => 'suomi',
         'fi-FI'          => 'suomi (Suomi)',
         'fil'            => 'Filipino',
         ...
         'ks'             => 'کٲشُر',
         'ks-Arab'        => 'کٲشُر (عربی)',
         'ks-Arab-IN'     => 'کٲشُر (ہِندوستان عربی)',
         'ks-Deva'        => 'कॉशुर (देवनागरी)',
         'ks-Deva-IN'     => 'कॉशुर (हिंदोस्तान देवनागरी)',
         'ksb'            => 'Kishambaa',
         ...
         'mn-MN'          => 'монгол (Монгол)',
         'mni'            => 'মৈতৈলোন্',
         'mni-Beng'       => 'মৈতৈলোন্ (বাংলা)',
         'mni-Beng-IN'    => 'মৈতৈলোন্ (ইন্দিয়া বাংলা)',
         'mr'             => 'मराठी',
         'mr-IN'          => 'मराठी (भारत)',
         'ms'             => 'Melayu',
         'ms-BN'          => 'Melayu (Brunei)',
         ...
         'pa'             => 'ਪੰਜਾਬੀ',
         'pa-Arab'        => 'پنجابی (عربی)',
         'pa-Arab-PK'     => 'پنجابی (پاکستان عربی)',
         'pa-Guru'        => 'ਪੰਜਾਬੀ (ਗੁਰਮੁਖੀ)',
         'pa-Guru-IN'     => 'ਪੰਜਾਬੀ (ਭਾਰਤ ਗੁਰਮੁਖੀ)',
         'pcm'            => 'Naijíriá (Píjin)',
         'pcm-NG'         => 'Naijíriá (Píjin Naijíria)',
         'pis'            => 'Pijin',
         'pis-SB'         => 'Pijin (Solomon Aelan)',
         'pl'             => 'polski',
         'pl-PL'          => 'polski (Polska)',
         'ps'             => 'پښتو',
         ...
         'sa'             => 'संस्कृत (भाषा)',
         'sa-IN'          => 'संस्कृत (भाषा भारतः)',
         'sah'            => 'саха (тыла)',
         'sah-RU'         => 'саха (тыла Арассыыйа)',
         'saq'            => 'Kisampur',
         'saq-KE'         => 'Kisampur (Kenya)',
         'sat'            => 'ᱥᱟᱱᱛᱟᱲᱤ',
         'sat-Olck'       => 'ᱥᱟᱱᱛᱟᱲᱤ (ᱚᱞ ᱪᱤᱠᱤ)',
         'sat-Olck-IN'    => 'ᱥᱟᱱᱛᱟᱲᱤ (ᱤᱱᱰᱤᱭᱟ ᱚᱞ ᱪᱤᱠᱤ)',
         'sbp'            => 'Ishisangu',
         ...
         'sd'             => 'سنڌي',
         'sd-Arab'        => 'سنڌي (عربي)',
         'sd-Arab-PK'     => 'سنڌي (پاڪستان عربي)',
         'sd-Deva'        => 'सिन्धी (देवनागिरी)',
         'sd-Deva-IN'     => 'सिन्धी (भारत देवनागिरी)',
         'se'             => 'davvisámegiella',
         ...
         'shi-Latn-MA'    => 'Tashelḥiyt (lmɣrib Latn)',
         'shi-Tfng'       => 'ⵜⴰⵛⵍⵃⵉⵜ (Tfng)',
         'shi-Tfng-MA'    => 'ⵜⴰⵛⵍⵃⵉⵜ (ⵍⵎⵖⵔⵉⴱ Tfng)',
         'si'             => 'සිංහල',
         ...
         'sr-Latn-BA'     => 'srpski (Bosna i Hercegovina latinica)',
         'sr-Latn-ME'     => 'srpski (Crna Gora latinica)',
         'sr-Latn-RS'     => 'srpski (Srbija latinica)',
         'sr-Latn-XK'     => 'srpski (Kosovo latinica)',
         'su'             => 'Basa (Sunda)',
         'su-Latn'        => 'Basa (Sunda Latin)',
         'su-Latn-ID'     => 'Basa (Sunda Indonesia Latin)',
         'sv'             => 'svenska',
         'sv-AX'          => 'svenska (Åland)',
         ...
         'uz'             => 'o‘zbek',
         'uz-Arab'        => 'اوزبیک (عربی)',
         'uz-Arab-AF'     => 'اوزبیک (افغانستان عربی)',
         'uz-Cyrl'        => 'ўзбекча (Кирил)',
         'uz-Cyrl-UZ'     => 'ўзбекча (Ўзбекистон Кирил)',
         'uz-Latn'        => 'o‘zbek (lotin)',
         'uz-Latn-UZ'     => 'o‘zbek (Oʻzbekiston lotin)',
         'vai'            => 'ꕙꔤ',
         'vai-Latn'       => 'Vai (Latn)',
         'vai-Latn-LR'    => 'Vai (Laibhiya Latn)',
         'vai-Vaii'       => 'ꕙꔤ (Vaii)',
         'vai-Vaii-LR'    => 'ꕙꔤ (ꕞꔤꔫꕩ Vaii)',
         'vi'             => 'Tiếng (Việt)',
         ...
         'yrl'            => 'nheẽgatu',
         'yrl-BR'         => 'nheẽgatu (Brasiu)',
         'yrl-CO'         => 'ñengatú (Kurũbiya)',
         'yrl-VE'         => 'ñengatú (Wenesuera)',
         'yue'            => '粵語',
         'yue-Hans'       => '粤语 (简体)',
         'yue-Hans-CN'    => '粤语 (中华人民共和国 简体)',
         'yue-Hant'       => '粵語 (繁體)',
         'yue-Hant-HK'    => '粵語 (中華人民共和國香港特別行政區 繁體)',
         'zgh'            => 'ⵜⴰⵎⴰⵣⵉⵖⵜ',
