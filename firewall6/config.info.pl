...
view_condition=Wy¶wietlaæ stan na li¶cie regu³?,1,1-Tak,0-Nie
view_comment=Wy¶wietlaæ komentarz na li¶cie regu³?,1,1-Tak,0-Nie
comment_mod=Zapisuj komentarze jako,1,0-# zapis w pliku komentarzy,1-&#45;&#45;opcja komentarzy
cluster_mode=Aktualizuj klaster serwerów,1,0-Zawsze&#44; gdy wprowadzono zmianê,1-Po zastosowaniu konfiguracji
...
save_file=ip6tables zapis pliku do edycji,3,U¿yj systemu operacyjnego lub Webmina
