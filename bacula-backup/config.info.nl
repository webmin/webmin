...
wait=Standaard backup wacht mode,1,1-Wacht tot hij kompleet is,0-Uitvoeren in de achtergrond
apply=Automatisch de director configuratie toevoegen?,1,1-Ja,0-Nee
groupmode=Krijg node groep informatie van,1,webmin-Webmin Servers Index module,oc-OCM Manager database,-Nergens
...
pass=Wachtwoord naar login met,0
