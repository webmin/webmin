...
wrap_width=Breedte om mail berichten in te maken op,0,6
wrap_compose=Breedte om mail berichten in te maken,10,-Niet veranderen,80-80 kolommen (standaard),Andere afmeting
perpage=Aantal mail berichten tonen per pagina,0,6
...
show_sent=Laat aantal berichten zien in de Verzonden mail folder?,1,1-Ja,0-Nee
fwd_mode=Berichten doorsturen met quota?,1,0-Ja,1-Nee
delete_warn=Vraag een bevestiging voordat word verwijder?,10,y-Ja,n-Nee,Voor mail box files groter dan
...
log_read=Lezen van mail opnemen in de Webmin Actie Log?,1,1-Ja,0-Nee
...
column_count=Aantal kolommen waarin gebruikersnamen word getoond,1,3-3,4-4,5-5,6-6,7-7,8-8,9-9
...
show_mail=Laat alleen gebruikers zien die mail hebben?,1,1-Ja,0-Nee
size_mode=Invoegen van alle folders in grote?,1,1-Ja,0-Nee (alleen de eerste folder)
ignore_users=Negeer deze gebruikersnamen (niet laten zien) ,15,userIgnoreList
...
check_mod=Controleer voor mailbox modificatie wanneer mail word verwijdert?,1,1-Ja,0-Nee
...
from_virtualmin=Verkrijgen van: adres van Virtualmin?,1,1-Ja,0-Nee
from_dom=Domein om te gebruiken van: adres,3,Systeem hostnaam
line1=Systeem configuratie,11
mail_system=Mail server geinstalleerd,4,1-Sendmail,0-Postfix,2-Qmail,4-Qmail+LDAP,5-Qmail+VPopMail,6-Exim,3-Detect automatisch
send_mode=Mail versturen met gebruik van,10,-Mail server programma,SMTP server
no_crlf=Voeg een interlinie toe ( \r ) aan iedere regel?,1,0-Ja,1-Nee
smtp_user=SMTP login naam voor mail server,3,Geen
smtp_pass=SMTP wachtwoord voor mail server,3,Geen
smtp_auth=SMTP identificatie methoden,4,-Standaard,Cram-MD5-Cram-MD5,Digest-MD5-Digest-MD5,Plain-Plain,Login-Login
auto=Detecteer locatie van mail files automatisch?,1,1-Ja, gebaseerd op mail server,0-Nee, gebruik de settings hieronder ..
mail_dir=Gebruiker mail file directory,3,Geen
...
mail_file=Mail file in gebruiker home directory,3,Geen
mail_sub=Mail directory in gebruikers home directory's,3,Geen
mail_usermin=Folder van subdirectory onder de home directory,3,Geen
mailbox_user=Usermin Leest Mail configuratie directory in home directory,3,Geen
