...
ftpd_path=Pełna ścieżka do <tt>wuftpd</tt>,0
ftpaccess=Pełna ścieżka do pliku <tt>ftpaccess</tt>,0
ftpconversions=Pełna ścieżka do pliku <tt>ftpconversions</tt>,0
