...
expert=Sta individuele selectie toe van opstartlevels?,1,1-Ja,0-Nee
desc=Laat acties zien met omschrijvingen,1,2-Ja&#44; en toon alle opstartlevels,1-Ja,0-Nee
order=Laat de boot volgorde zien van de acties?,1,1-Ja,0-Nee
status_check=Toon de huidige status van de acties,1,2-op index en actie pagina,1-Alleen op actie pagina,0-Nee
sort_mode=Sorteer acties met,1,1-Boot volgorde,0-Naam
line2=Systeem configuratie,11
init_base=Directory waarin de opstartlevel directory's geplaatst zijn,0
...
boot_levels=Opstartlevels waar nieuwe acties in gemaakt worden,3,Van /etc/inittab
...
inittab_id=Inittab ID voor bootup opstartlevel,0
