# Common functions and globals for miniserv.pl. miniserv.pl requires this
# file in a BEGIN block so Socket constants are imported before the daemon
# startup code is compiled.
package miniserv;
use Socket;
use POSIX;
use Time::Local;
