...
mailq_show=Headers die getoond moeten worden in de wachtrij,2,Date-Datum,From-Van,To-Naar,Subject-Onderwerp,Cc-Cc,Size-Grote,Status-Status,Dir-Directory
...
mailq_order=Vermelden wanneer de mail wachtrij verwijderd word,1,-Standaard,priority-Prioriteit,host-Hostnaam,time-Datum ontvangen
...
mail_sync=Gebruiker mail file synchronisatie,2,create-Maak met gebruiker,delete-Verwijder met gebruiker,modify-Hernoem met gebruiker
